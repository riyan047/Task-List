    ...
    <div className='bg-black text-white py-[72px]'>
      <div className="container">
        ...
        <div className='max-w-xl mx-auto'>
          <p className='text-center mt-5 text-xl text-white/70'>Enjoy customizable lists, team work tools,
            and smart tracking all in one place. Set tasks,
        ...
        <div className="mt-16 flex flex-wrap justify-center gap-6">
          {features.map((item, index) => (
            <div
              key={index}
              className="w-[360px] h-[260px] border border-white/30 px-5 py-10 text-center rounded-xl"
            >
